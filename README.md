...
## Installation
  ...
  ```
  $ git clone https://github.com/AndresFMoya/RoR-Microposts.git
...
Contributions, issues and feature requests are welcome! Feel free to check [issues page](https://github.com/AndresFMoya/RoR-Microposts/issues).

1. Fork it (https://github.com/AndresFMoya/RoR-Microposts/fork)
...
This project is [MIT](https://github.com/AndresFMoya/RoR-Microposts/blob/develop/LICENSE) licensed.
